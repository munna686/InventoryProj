...
namespace InventoryProj.Infrastructure.Repos
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(IDbContextTransaction currentTransaction, InventoryDataContext context, IBomRepository bom, IProductRepository product, IRawMaterialRepository material, IUserRepository user)
        {
